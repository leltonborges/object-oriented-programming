...
public class StreamMatch {
	...
	public static void main(String[] args) {
		...
		System.out.println(listStudents.stream().allMatch(approvedStudent));
		System.out.println(listStudents.stream().anyMatch(approvedStudent));
		System.out.println(listStudents.stream().noneMatch(approvedStudent));
